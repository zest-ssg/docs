...
|---|---|---|---|---|
| 模板即代码 | ✅ F# DSL | ❌ | 部分（模板函数） | ✅ `.11ty.js` |
| 多模板引擎 | ✅ 六种以上 | Liquid | Go 模板 | 多种 |
| 零配置 | ✅ | 部分 | 部分 | ✅ |
| 迁移工具 | ✅ `zest migrate` | — | — | — |
| 兼容模式 | ✅ `[compat]` 逐项开启 | — | — | — |

Zest 主要学习的对象就是 **11ty/Eleventy**：同样追求"约定优于配置"、模板语言可自由替换、构建期全静态输出。在此基础上，Zest 进一步用 F# DSL 让模板本身成为类型安全的代码，并对 Jekyll / Hexo / Hugo / 11ty 提供可选的 `[compat]` 兼容开关，便于从既有项目迁移。
